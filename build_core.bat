...
echoj $0a $ba " Shotgun Frenzy Plus Core builder! " $ba 
...
:GIT_BUILD
chgcolor 0B
echo Compiling Shotgun Frenzy Plus Core Rev#: %REVISIONNUMBER%...
pause
del .\builds\gits\sfplus_core_r%REVISIONNUMBER%.pk3 /q

cd core
7za a -y -tzip -mx=9 -mmt -x!.svn ..\builds\gits\sfplus_core_r%REVISIONNUMBER%.pk3 .\ && echo Sucess! && echoj $07
pause
goto MENU
...
echo Compiling Shotgun Frenzy Plus Core ( %RELASE% )...
pause
del .\builds\relases\sfplus_core_%RELASE%.pk3 /q

cd core
7za a -y -tzip -mx=9 -mmt -x!.svn ..\builds\relases\sfplus_core_%RELASE%.pk3 .\ && echo Sucess! && echoj $07
...
echo Compiling Shotgun Frenzy Plus Core Local Dev Build...
pause
del .\sfplus_core-d.pk3 /q

cd core
7za a -y -tzip -mx=0 -mmt -x!.svn ..\sfplus_core-d.pk3 .\ && echo Sucess! && echoj $07
