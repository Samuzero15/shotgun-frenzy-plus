...
echo to be used after each coding session, to update and commit directly to the git.
...
echo This bat will delete the folders core, res and mus from the directory.
